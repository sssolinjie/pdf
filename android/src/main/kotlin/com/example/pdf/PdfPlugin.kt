...
import com.example.pdf.resources.DocumentRepository
import com.example.pdf.resources.PageRepository
import com.example.pdf.resources.RepositoryItemNotFoundException
import com.example.pdf.utils.CreateRendererException
import com.example.pdf.utils.randomFilename
import com.example.pdf.utils.toFile
import java.io.File
...
class PdfPlugin: FlutterPlugin, MethodCallHandler {
  ...
  override fun onAttachedToEngine(flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    ...
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "pdf")
  ...
  private fun closeDocumentHandler(call: MethodCall, result: Result) {
    try {
      val id: String  = call.arguments<String>()?: ""
      documents.close(id)
      result.success(null)
    } catch (e: NullPointerException) {
